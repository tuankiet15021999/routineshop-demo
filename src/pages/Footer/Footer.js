            ...
            <div className="footer-top">
                ...
                <div className="parallax">
                    <div className="custom-bottom">
							...
							<div className="des-1">CHO ĐƠN HÀNG TRÊN 500K</div>
							<div className="des-2">CHƯƠNG TRÌNH NÀY ĐƯỢC ÁP DỤNG TRÊN MỌI MẶT HÀNG CỦA CHÚNG TÔI</div>
                    </div>
                </div>
                </div>
            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6 col-lg-3 footer-menu">
                            ...
                            <ul className="lienket">
                                <li><a className="fab fa-facebook" href="#"></a></li>
                                <li><a className="fab fa-twitter" href="#"></a></li>
                                <li><a className="fab fa-google-plus-g" href="#"></a></li>
                                <li><a className="fab fa-pinterest" href="#"></a></li>
                                <li><a className="fas fa-rss" href="#"></a></li>
                            </ul>
                        </div>
